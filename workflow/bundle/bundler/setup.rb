...
$:.unshift File.expand_path("#{path}/../#{ruby_engine}/#{ruby_version}/gems/multi_json-1.8.2/lib")
...
$:.unshift File.expand_path("#{path}/../#{ruby_engine}/#{ruby_version}/gems/xml-simple-1.1.2/lib")
$:.unshift File.expand_path("#{path}/../#{ruby_engine}/#{ruby_version}/gems/lastfm-1.21.0/lib")
$:.unshift File.expand_path("#{path}/../#{ruby_engine}/#{ruby_version}/gems/r18n-core-1.1.7/lib")
$:.unshift File.expand_path("#{path}/../#{ruby_engine}/#{ruby_version}/gems/r18n-desktop-1.1.7/lib")
